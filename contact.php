        ...
        <div class="container position-relative">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2>Contact us</h2>
                    <p class="w-lg-50">24/7 Uninterrupted Support</p>
                </div>
            </div>
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-start h-100">
                        ...
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="mb-0"><span style="color: rgb(26, 25, 25); background-color: rgb(255, 255, 255);">Andover ,MA, US</span></p>
                            </div>
                        </div>
                    </div>
                </div>
